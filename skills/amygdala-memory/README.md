...
- 🎭 Emotions (amygdala-memory)
- 🧠 Memory (hippocampus — or install prompt)
- ⭐ Drive (vta-memory — or install prompt)
- 🎯 Habits (basal-ganglia-memory — or install prompt)
- 🌡️ Sense (insula-memory — or install prompt)
- ⚡ Oversight (anterior-cingulate-memory + acc-error-memory — or install prompt)
